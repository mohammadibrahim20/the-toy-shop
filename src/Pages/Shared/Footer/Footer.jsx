...
const Footer = () => {
  return (
    <footer aria-label="Site Footer" className="bg-gray-900">
      <div className="mx-auto max-w-screen-xl px-4 pb-6 pt-5 sm:px-6 lg:px-8 lg:pt-10">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            <div className="flex justify-center text-teal-300 sm:justify-start">
            <img src="https://i.ibb.co/sRmcpRR/logo.png" className="h-16" alt="" />
            </div>
            <p className="mt-6 max-w-md text-center leading-relaxed text-white sm:max-w-xs sm:text-left">
              Largest product search Tedy shop, maximum categorized online shopping
              mall and quickest home delivery system.
            </p>
            <ul className="mt-8 flex justify-center gap-6 sm:justify-start md:gap-8">
              <li>
                <Link
                  to="https://www.facebook.com/ibrahimarham.baffi"
                  rel="noreferrer"
                  target="_blank"
                  className="transition text-indigo-500 hover:text-indigo-500/75"
                >
              ...
              <ul className="mt-8 space-y-4 text-sm">
                ...
                <li className="flex items-start justify-center gap-1.5 ltr:sm:justify-start rtl:sm:justify-end">
                  ...
                  <address className="-mt-0.5 flex-1 not-italic text-gray-300">
                    Fatickchari, Chittagong, Bangladesh
                  </address>
                </li>
              </ul>
            </div>
        ...
        <div className="mt-12 border-t  pt-6 border-gray-800">
          <div className="text-center sm:flex sm:justify-between sm:text-left">
            <p className="text-smtext-gray-400">
              ...
              <a
                className="inline-block  underline transition  text-indigo-500 hover:text-indigo-500/75"
                href="/"
              >
                Terms &amp; Conditions
              </a>
